...
void AccessibilityConfig::Impl::AccessibilitySaStatusChange::OnAddSystemAbility(int32_t saId, const std::string &deviceId)
{
    HILOG_DEBUG();
...
void AccessibilityConfig::Impl::AccessibilitySaStatusChange::OnRemoveSystemAbility(int32_t saId, const std::string &deviceId)
{
    HILOG_DEBUG();
    if (config_) {
