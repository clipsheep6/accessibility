...
void AccessibleAbilityClientImpl::AccessibilitySaStatusChange::OnAddSystemAbility(int32_t saId, const std::string &deviceId)
{
    if (AccessibleAbilityClientImpl::GetAbilityClientImplement() &&
...
void AccessibleAbilityClientImpl::AccessibilitySaStatusChange::OnRemoveSystemAbility(int32_t saId, const std::string &deviceId)
{
