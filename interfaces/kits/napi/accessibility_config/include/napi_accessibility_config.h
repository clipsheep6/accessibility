...
private:
    ...
    static void SetConfigExcludeColorFilter(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
        NAccessibilityConfigData* callbackInfo);
    static void SetColorFilterConfig(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
        NAccessibilityConfigData* callbackInfo);
    ...
    static void GetConfigExcludeTimeoutAndColorFilter(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
        NAccessibilityConfigData* callbackInfo);
    static void GetTimeoutAndColorFilterConfig(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
        NAccessibilityConfigData* callbackInfo);
