...
void NAccessibilityConfig::SetConfigExcludeColorFilter(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
    NAccessibilityConfigData* callbackInfo)
{
...
void NAccessibilityConfig::SetColorFilterConfig(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
    NAccessibilityConfigData* callbackInfo)
{
...
void NAccessibilityConfig::SetConfigExecute(napi_env env, void* data)
{
    ...
    auto &instance = OHOS::AccessibilityConfig::AccessibilityConfig::GetInstance();
    SetConfigExcludeColorFilter(instance, callbackInfo);
    SetColorFilterConfig(instance, callbackInfo);
}
...
void NAccessibilityConfig::GetConfigExcludeTimeoutAndColorFilter(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
    NAccessibilityConfigData* callbackInfo)
{
    switch (callbackInfo->id_) {
        case OHOS::AccessibilityConfig::CONFIG_ID::CONFIG_HIGH_CONTRAST_TEXT:
...
void NAccessibilityConfig::GetTimeoutAndColorFilterConfig(OHOS::AccessibilityConfig::AccessibilityConfig& instance,
    NAccessibilityConfigData* callbackInfo)
{
...
void NAccessibilityConfig::GetConfigExecute(napi_env env, void* data)
{
    ...
    auto &instance = OHOS::AccessibilityConfig::AccessibilityConfig::GetInstance();
    GetConfigExcludeTimeoutAndColorFilter(instance, callbackInfo);
    GetTimeoutAndColorFilterConfig(instance, callbackInfo);
}
