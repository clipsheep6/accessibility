...
public:
    ...
    /**
     * @brief Set the elementInfo associated with the accessibility event.
     * @param elementInfo The elementInfo associated with the accessibility event.
     * @since 12
     * @sysCap Accessibility
     */
    ...
    /**
     * @brief Gets the elementInfo pointer associated with the accessibility event.
     * @return The elementInfo associated with the accessibility event.
     * @since 12
     * @sysCap Accessibility
     */
    std::shared_ptr<AccessibilityElementInfo> GetElementInfo() const;
