...
RetError AccessibleAbilityManagerService::SetScreenMagnificationState(const bool state)
{
    ...
    HITRACE_METER_NAME(HITRACE_TAG_ACCESSIBILITY_MANAGER, "SetScreenMagnificationState");
...
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
    HITRACE_METER_NAME(HITRACE_TAG_ACCESSIBILITY_MANAGER, "SetShortKeyState");
...
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
    HITRACE_METER_NAME(HITRACE_TAG_ACCESSIBILITY_MANAGER, "SetHighContrastTextState");
...
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
    HITRACE_METER_NAME(HITRACE_TAG_ACCESSIBILITY_MANAGER, "SetAudioMonoState");
...
RetError AccessibleAbilityManagerService::SetAudioBalance(const float balance)
{
    ...
    HITRACE_METER_NAME(HITRACE_TAG_ACCESSIBILITY_MANAGER, "SetAudioBalance");
