...
#endif
    std::shared_ptr<A11yRSUIDirectorProxy> rsUiDirector_ = nullptr;
    std::shared_ptr<A11yRSSurfaceNodeProxy> surfaceNode_ = nullptr;
    std::shared_ptr<A11yRSCanvasNodeProxy> canvasNode_ = nullptr;
    std::shared_ptr<A11yRSNodeProxy> rootNode_ = nullptr;
